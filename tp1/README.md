...
1. [Ajouter un module d'hyperpropulsion](exercices/exercice-hyperdrive-module.md) (Difficulté: 5/5)
...
4. [Évaluer et réusiner les tests unitaires de Booking.validate](exercices/exercice-tests-validate-booking-refactor.md) (Difficulté: 1/5)